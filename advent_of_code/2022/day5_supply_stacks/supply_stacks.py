...
def main(input_path: str, part: int) -> int:
    ...
    # Consider the bottom-most crate as height of 0
...
if __name__ == "__main__":
    full_input_path = load.get_full_file_path("input.txt")

    part1_solution = main(full_input_path, 1)
    print(f"Part 1 solution: {part1_solution}")

    part2_solution = main(full_input_path, 2)
